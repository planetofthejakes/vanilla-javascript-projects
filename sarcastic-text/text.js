...
const filters = {
  sarcastic(letter, index) {
    ...
    // if it is even then return zero and lowercase
    return letter.toLowerCase();
  },
  funky(letter) {
    // check if there's a funky letter for this case
    let funkyLetter = funkyLetters[letter];
    if(funkyLetter) return funkyLetter;
    // if there is not then check if there's a lowercase version
